    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
                    Home</a> <a href="classes.php" class="tip-bottom">Classes</a> <a href="#" class="current">Add
                    Class</a> </div>
        </div>
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['classname'])) {
                ...
                $qry = "INSERT INTO classes(classname,trainer,start_time,end_time,date,capacity,amount) values ('$classname','$trainer','$starttime','$endtime','$date', '$capacity', '$amount')";
                ...
                if (!$result) {
                    ...
                    echo "<div class='error_ex'>";
                    echo "<h1>Success</h1>";
                    echo "<h3>Class details has been added!</h3>";
                    echo "<p>Click the button to go back.</p>";
                    echo "<a class='btn btn-inverse btn-big'  href='classes.php'>Go Back</a> </div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
