<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="<?php if($page=='classes'){ echo 'active'; }?>"><a href="classes.php"><i class="fas fa-calendar"></i> <span>Classes</span></a></li>
    <li class="<?php if($page=='reminder'){ echo 'active'; }?>"><a href="member-reminder.php"><i class="fas fa-bell"></i> <span>Reminders</span></a></li>
