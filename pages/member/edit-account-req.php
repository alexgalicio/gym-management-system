    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
                    Home</a> <a href="edit-account.php" class="tip-bottom">Account</a> <a href="#" class="current">Edit
                    Account</a> </div>
        </div>
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['fullname'])) {
                ...
                include 'dbcon.php';
                $qry = "update members set fullname='$fullname', username='$username', gender='$gender', address='$address', contact='$contact', email='$email' where user_id='$id'";
                ...
                if (!$result) {
                    ...
                    echo "<a class='btn btn-warning btn-big'  href='edit-account.php'>Go Back</a> </div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    ...
                    echo "<div class='error_ex'>";
                    echo "<h1>Success</h1>";
                    echo "<h3>Your details has been updated!</h3>";
                    echo "<p>Click the button to go back.</p>";
                    echo "<a class='btn btn-inverse btn-big'  href='edit-account.php'>Go Back</a> </div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
