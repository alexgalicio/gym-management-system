    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
                    ...
                    class="current">Add Promo & Offers</a> </div>
        </div>
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['name'])) {
                ...
                include 'dbcon.php';
                $qry = "INSERT INTO offers(name,amount,description,duration,type) values ('$name','$amount','$description', '$duration', '$types')";
                ...
                if (!$result) {
                    ...
                    echo "<div class='error_ex'>";
                    echo "<h1>Success</h1>";
                    echo "<h3>Promo & Offers details has been added!</h3>";
