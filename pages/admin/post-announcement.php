  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
          Home</a> <a href="#" class="current">Announcement</a> </div>
    </div>
    <form role="form" action="index.php" method="POST">
      ...
      if (isset($_POST['message'])) {
        ...
        include 'dbcon.php';
        $stmt = $con->prepare("INSERT INTO announcements (message, date) VALUES (?, ?)");
        $stmt->bind_param("ss", $message, $date); // "ss" means both parameters are strings
        ...
        if ($stmt->execute()) {
          ...
          echo "<h1>Success</h1>";
          echo "<h3>Announcement has been posted!</h3>";
