  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
          Home</a> <a href="equipment.php" class="current">Gym Equipment</a> </div>
      <h1 class="text-center">Equipment List </i></h1>
    </div>

    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span12">
          <a href="equipment-entry.php"><button class="btn btn-primary">Add Equipment</button></a>
              ...
              while ($row = mysqli_fetch_array($result)) {
                echo "<tbody> 
                  ...
                  ($row['status'] === 'Active' ? 'badge-success' :
                    ($row['status'] === 'Maintenance' ? 'badge-warning' : 'badge-important')) . "'>
                          " . $row['status'] . "
                      </span>
                    </div></td>
                    <td><div class='text-center'>
                    <a href='edit-equipmentform.php?id=" . $row['id'] . "' class='tip-bottom' title='Edit'><i class='fas fa-edit' style='color:#367E18'></i> | </a>
                    <a href='actions/delete-equipment.php?id=" . $row['id'] . "' class='tip-bottom' title='Delete' style='color:#f74d4d;'><i class='fas fa-trash'></i></a></div></td>
                </tbody>";
                $cnt++;
              }
              ?>
