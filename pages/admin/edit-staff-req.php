    ...
    <div id="content">
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['fullname'])) {
                ...
                include 'dbcon.php';
                $qry = "update staffs set fullname='$fullname', gender='$gender', contact='$contact', email='$email', address='$address', designation='$designation' where user_id='$id'";
                ...
                if (!$result) {
                    ...
                    echo "<div class='error_ex'>";
                    echo "<h1>Success</h1>";
                    echo "<h3>Staff details has been updated!</h3>";
