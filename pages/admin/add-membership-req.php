  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
          Home</a> <a href="membership.php" class="tip-bottom">Members</a> <a href="#" class="current">Add
          Members</a> </div>
    ...
    <form role="form" action="index.php" method="POST">
      ...
      if (isset($_POST['name'])) {
        ...
        include 'dbcon.php';
        $qry = "INSERT INTO membership(name,validity,inclusions,amount) values ('$name','$validity','$inclusions','$amount')";
