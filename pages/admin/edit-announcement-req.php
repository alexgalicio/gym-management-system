    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
                    Home</a><a href="announcement.php">Announcement</a> <a href="manage-announcement.php">Manage
                    Announcement</a>
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['message'])) {
                ...
                include 'dbcon.php';
                $stmt = $con->prepare("UPDATE announcements SET message = ?, date = ? WHERE id = ?");
                $stmt->bind_param("ssi", $message, $date, $id);
                ...
                if ($stmt->execute()) {
                    ...
                    echo "<h1>Success</h1>";
                    echo "<h3>Announcement has been updated!</h3>";
                    echo "<p>Click the button to go back.</p>";
                    echo "<a class='btn btn-inverse btn-big'  href='manage-announcement.php'>Go Back</a> </div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
