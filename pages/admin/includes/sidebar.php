<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="<?php if ($page == 'promo-offers') {echo 'active';} ?>"><a href="promo-offers.php"><i class="fas fa-tags"></i> <span> Promo & Offers</span></a></li>
    <li class="<?php if ($page == 'classes') {echo 'active';} ?>"><a href="classes.php"><i class="fas fa-calendar-alt"></i> <span> Classes</span></a></li>
    <li class="<?php if ($page == 'equipment') {echo 'active';} ?>"><a href="equipment.php"><i class="fas fa-dumbbell"></i><span>Gym Equipment</span></a></li>
    <li class="<?php if ($page == 'attendance') {echo 'active';} ?>"><a href="attendance.php"><i class="fas fa-calendar-alt"></i><span>Attendance</span></a></li>
