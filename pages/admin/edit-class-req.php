    ...
    <div id="content">
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['classname'])) {
                ...
                $qry = "update classes set classname='$classname', trainer='$trainer', start_time='$starttime', end_time='$endtime', date='$date', capacity='$capacity', amount='$amount' where id='$id'";
                ...
                if (!$result) {
                    ...
                    echo "<div class='error_ex'>";
                    echo "<h1>Success</h1>";
                    echo "<h3>Class details has been updated!</h3>";
