...
<body>
    ...
    include 'dbcon.php';
    $id = $_GET['id'];
    $qry = "select * from offers where id='$id'";
    $result = mysqli_query($con, $qry);


    while ($row = mysqli_fetch_array($result)) {
        $selectedTypes = explode(',', $row['type']);
        ?>
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb">
                    <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>Home</a>
                    <a href="promo-offers.php" class="tip-bottom">Promo & Offers</a> <a href="#" class="current">Edit Promo
                        & Offers</a>
                </div>
                <h1 class="text-center">Edit Promo & Offers</h1>
            </div>
                    ...
                    <div class="span12">
                        <div class="widget-box widget-box-bordered">
                            ...
                            <div class="widget-content nopadding">
                                <form action="edit-promo-offers-req.php" method="POST" class="form-horizontal">
                                    <div class="control-group">
                                        <label class="control-label">Name :</label>
                                        <div class="controls">
                                            <input type="text" class="span11" name="name" minlength="3" required
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" min="0" step="0.01" class="span11" name="amount" required
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" class="span11" name="duration" required min="0"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        <label>
                                            <input type="checkbox" name="type[]" value="Walk-in" 
                                            <?php if (in_array('Walk-in', $selectedTypes)) echo 'checked'; ?>>
                                            Walk-in
                                        </label>
                                        <label>
                                            <input type="checkbox" name="type[]" value="Regular" 
                                            <?php if (in_array('Regular', $selectedTypes)) echo 'checked'; ?>>
                                            Regular
                                        </label>
                                        <label>
                                            <input type="checkbox" name="type[]" value="Student" 
                                            <?php if (in_array('Student', $selectedTypes)) echo 'checked'; ?>>
                                            Student
                                        </label>
