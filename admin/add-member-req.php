  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
          Home</a> <a href="members.php" class="tip-bottom">Members</a> <a href="#" class="current">Add
          Members</a> </div>
    </div>
    ...
    <form role="form" action="index.php" method="POST">
      ...
      if (isset($_POST['fullname'])) {
        ...
        if ($type == 'Student' || $type == 'Walk-in') {
          ...
          $amount = 300;
          $status = 'Active';
          $membership_end = date("Y-m-d", strtotime("+12 months", strtotime($membership_start))); // Add 12 months for others
        }

        $qry = "INSERT INTO members(fullname,username,password,gender,type,amount,address,contact,email,membership_start,membership_end,status) values ('$fullname','$username','$password','$gender','$type', '$amount','$address','$contact','$email','$membership_start','$membership_end', '$status')";
