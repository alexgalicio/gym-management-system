    ...
    <div id="content">
      <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
            Home</a><a href="announcement.php">Announcement</a> <a href="manage-announcement.php">Manage Announcement</a>
          <a href="#.php" class="current">Edit Announcement</a>
        </div>
          ...
          <div class="widget-box widget-box-bordered">
            ...
            <div class="widget-content">
              <div class="control-group">
                <form action="edit-announcement-req.php" method="POST">
                  <div class="controls">
                    <textarea class="span12" style="resize: none;" name="message" required
                      rows="6"><?php echo htmlspecialchars($row['message']); ?></textarea>
                  </div>
                  <div class="controls">
                    <h5>
                      <label for="Announce Date">Date:
                        <input type="date" name="date" value="<?php echo $row['date']; ?>"> </label>
                      <input type="hidden" name="id" value="<?php echo $row['id']; ?>"> </label>
                    </h5>
                  </div>
