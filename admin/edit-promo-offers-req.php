    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
                    Home</a> <a href="promo-offers.php" class="tip-bottom">Promo & Offers</a> <a href="#"
                    class="current">Edit Promo & Offers</a> </div>
        </div>
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['name'])) {
                ...
                $types = isset($_POST["type"]) ? implode(",", $_POST["type"]) : '';

                include 'dbcon.php';
                $qry = "update offers set name='$name', description='$description',amount='$amount', duration='$duration', type='$types' where id='$id'";
                ...
                if (!$result) {
                    ...
                    echo "<a class='btn btn-warning btn-big'  href='promo-offers.php'>Go Back</a> </div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    ...
                    echo "<div class='error_ex'>";
                    echo "<h1>Success</h1>";
                    echo "<h3>Promo & Offers details has been updated!</h3>";
                    echo "<p>Click the button to go back.</p>";
                    echo "<a class='btn btn-inverse btn-big'  href='promo-offers.php'>Go Back</a> </div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
